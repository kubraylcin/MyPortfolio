...
namespace MyPortfolio.Controllers
{
    ...
    public class ProfileController : Controller
    {
        ...
        public ProfileController(IHttpContextAccessor httpContextAccessor, MyPortfolioContext context, UserManager<AppUser> userManager, SignInManager<AppUser> signInManager, IImageHelper imageHelper)
        {
